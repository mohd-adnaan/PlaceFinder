...
-keep class com.example.imunavigation.InitializeRequest { *; }
-keep class com.example.imunavigation.UpdateRequest { *; }
-keep class com.example.imunavigation.NavigationResponse { *; }
